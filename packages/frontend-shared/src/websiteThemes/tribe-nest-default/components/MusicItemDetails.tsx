...
import type { EditorTheme, IPublicProduct, IPublicProductTrack, IPublicProductVariant } from "../../../types";
...
export function MusicItemDetails({ product }: { product: IPublicProduct }) {
          ...
          <div className="flex flex-col @md:flex-row gap-6">
            ...
            <div className="relative">
              ...
              >
                ...
                >
                  {isPlaying && currentTractBelongsToProduct ? <Pause size={32} /> : <Play size={32} />}
                </button>
              </div>
            </div>
