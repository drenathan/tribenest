...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile ? <MenuIcon color="white" size={50} /> : <PanelLeftIcon color="white" />}
