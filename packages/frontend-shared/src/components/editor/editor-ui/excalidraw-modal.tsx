...
type Props = {
   ...
   */
  onSave: (elements: ExcalidrawInitialElements, appState: Partial<any>, files: any) => void;
};

export const useCallbackRefState = () => {
  const [refValue, setRefValue] = React.useState<any | null>(null);
  const refCallback = React.useCallback((value: any | null) => setRefValue(value), []);
