          ...
          {channels?.data?.map((channel) => {
            ...
            return (
              <div
                ...
                key={channel.id}
                className={cn(
                  "flex items-center justify-center flex-col gap-2 border border-muted-foreground rounded-md p-2 cursor-pointer hover:bg-muted-foreground/10 transition-all duration-300",
              ...
              >
                ...
                <p className="text-sm font-medium text-center">{channel.title}</p>
              </div>
            );
          })}
        </div>
